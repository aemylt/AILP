...
q4a([p(2, 2), p(2, 3), p(2, 4), p(3, 4), p(4, 4), p(4, 3), p(3, 3), p(3, 2), p(4, 2), p(4, 1), p(3, 1), p(2, 1), p(1, 1), p(1, 2), p(1, 3), p(1, 4)]).

q4b([p(2,2),p(2,3),p(2,4),p(3,4),p(4,4),p(4,3),p(3,3),p(3,2),p(3,1),p(4,1),p(4,2)]).
